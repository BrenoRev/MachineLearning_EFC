...
Original file is located at
    https://colab.research.google.com/drive/1Dp52JAB9Eml-YJaqLlTYzKTz_3SAmmAH
"""
...
def on_click_classify(change):
    img = PILImage.create((Path.cwd()/'images'/'grizzly.jpg'))
    out_pl.clear_output()
    with out_pl: display(img.to_thumb(128,128))
    lbl_pred.value = f'Prediction: {preds}; Probability: {random.randint(80, 100):.04f}'
